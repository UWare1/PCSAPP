...
public class Main2DoctorActivity extends AppCompatActivity {
            ...
            public void onShowItem(MeowBottomNavigation.Model item) {
                ...
                switch (item.getId()){
                    case 1:
                        ...
                        fragment = new ChatDoctorFragment();
                        break;
                    case 2:
                        //When id is 2
                        //Initialize history fragment
                        fragment = new HistoryDoctorFragment();
                        break;
                    case 3:
                        //When id is 3
                        //Initialize Homepage fragment
                        fragment = new HomepageDoctorFragment();
                        break;
                    case 4:
                        //When id is 4
                        //Initialize Noti fragment
                        fragment = new NotiDoctorFragment();
                        break;
                    case 5:
                        //When id is 4
                        //Initialize Noti fragment
                        fragment = new UserDoctorFragment();
                        break;

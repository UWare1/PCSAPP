 ...
 * Use the {@link UserDoctorFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UserDoctorFragment extends Fragment {
     ...
     * @return A new instance of fragment UserDoctorFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UserDoctorFragment newInstance(String param1, String param2) {
        UserDoctorFragment fragment = new UserDoctorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Fullname = UserDetails.get(SessionManagerDoctor.KEY_FULLNAME);
        BornDB = UserDetails.get(SessionManagerDoctor.KEY_DATE);
                ...
                exit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (IFCHOOSE) {
                            ...
                            DatabaseReference reference = rootNode.getReference("Doctor").child(DoctorID);
